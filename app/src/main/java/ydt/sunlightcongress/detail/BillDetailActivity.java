...
public class BillDetailActivity extends AppCompatActivity{
    ...
    private void initView(){
        ...
        ((TextView)findViewById(R.id.detail_bill_item_id).findViewById(R.id.detail_item_value)).setText(TextUtils.isEmpty(bill.bill_id) ? "None": bill.bill_id);

        ((TextView)findViewById(R.id.detail_bill_item_title).findViewById(R.id.detail_item_key)).setText("Title: ");
        ((TextView)findViewById(R.id.detail_bill_item_title).findViewById(R.id.detail_item_value)).setText(TextUtils.isEmpty(bill.short_title) ? "None" : bill.short_title);

        ((TextView)findViewById(R.id.detail_bill_item_type).findViewById(R.id.detail_item_key)).setText("Bill Type: ");
        ((TextView)findViewById(R.id.detail_bill_item_type).findViewById(R.id.detail_item_value)).setText(TextUtils.isEmpty(bill.bill_type) ? "None" : bill.bill_type);
        ...
        ((TextView)findViewById(R.id.detail_bill_item_chamber).findViewById(R.id.detail_item_value)).setText(TextUtils.isEmpty(bill.chamber) ? "None" : bill.chamber);
        ...
        ((TextView)findViewById(R.id.detail_bill_item_version).findViewById(R.id.detail_item_value)).setText((bill.last_version == null || TextUtils.isEmpty(bill.last_version.version_name)) ? "None" : bill.last_version.version_name);

        ((TextView)findViewById(R.id.detail_bill_item_bill).findViewById(R.id.detail_item_key)).setText("Bill URL: ");
        ((TextView)findViewById(R.id.detail_bill_item_bill).findViewById(R.id.detail_item_value)).setText((bill.urls == null || !bill.urls.containsKey("html")) ? "None" : bill.urls.get("html"));
